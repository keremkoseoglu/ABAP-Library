CLASS zcl_bc_restful_server DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS accept_json_input
      IMPORTING
        !apiid             TYPE zbct_restful_001-apiid
        !json_input        TYPE string
      RETURNING
        VALUE(json_output) TYPE string.
...
CLASS zcl_bc_restful_server IMPLEMENTATION.
  ...
  METHOD accept_json_input.
    TRY.
        ...
        json_output = api->imp->accept_json_input( json_input ).
  ...
  METHOD exception_to_json.
    ...
    extract_exception_texts(
      EXPORTING exception = exception
  ...
  METHOD extract_exception_texts.
    ...
    extract_exception_texts(
      EXPORTING exception = exception->previous
